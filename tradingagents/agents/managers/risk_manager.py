def create_risk_manager(llm, memory):
    def risk_manager_node(state) -> dict:
        ...
        prompt = (
            ...
            " Buy, Sell, or Hold. Choose Hold only if strongly justified by specific arguments,"
            " not as a fallback when all sides seem valid."
            ...
            " and counterarguments from the debate.\n"
            f"3. **Refine the Trader's Plan**: Start with the trader's original plan,"
            f" **{trader_plan}**, and adjust it based on the analysts' insights.\n"
            f"4. **Learn from Past Mistakes**: Use lessons from **{past_memory_str}**"
            " to address prior misjudgments and improve the decision you are making now"
            ...
            " Build on past lessons, critically evaluate all perspectives,"
