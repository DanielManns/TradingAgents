def create_research_manager(llm, memory):
    def research_manager_node(state) -> dict:
        ...
        prompt = (
            ...
            " this round of debate and make a definitive decision: align with the bear analyst,"
            " the bull analyst, or choose Hold only if it is strongly justified based on the"
            " arguments presented.\n\n"
            ...
            " refine your decision-making and ensure you are learning and improving."
            " Present your analysis conversationally, as if speaking naturally,"
