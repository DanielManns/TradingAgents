def create_bear_researcher(llm, memory):
    def bear_node(state) -> dict:
        ...
        prompt = (
            ...
            "- Negative Indicators: Use evidence from financial data, market trends,"
            " or recent adverse news to support your position.\n"
            ...
            " with the bull analyst's points and debating effectively"
            ...
            " in the stock. You must also address reflections and learn from lessons"
