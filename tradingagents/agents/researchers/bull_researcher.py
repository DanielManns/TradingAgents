def create_bull_researcher(llm, memory):
    def bull_node(state) -> dict:
        ...
        prompt = (
            ...
            " Leverage the provided research and data to address concerns"
            ...
            " and recent positive news as evidence.\n"
            "- Bear Counterpoints: Critically analyze the bear argument with specific data"
            " and sound reasoning, addressing concerns thoroughly and showing why the bull"
            " perspective holds stronger merit.\n"
            "- Engagement: Present your argument in a conversational style,"
            " engaging directly with the bear analyst's points and debating effectively"
            ...
            " You must also address reflections and learn from lessons"
            " and mistakes you made in the past.\n"
        )
