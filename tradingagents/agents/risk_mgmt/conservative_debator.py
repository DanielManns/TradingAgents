def create_conservative_debator(llm):
    def conservative_node(state) -> dict:
        ...
        prompt = (
            ...
            " and market volatility. When evaluating the trader's decision or plan, critically examine"
            " high-risk elements, pointing out where the decision may expose the firm to undue risk"
            " and where more cautious alternatives could secure long-term gains."
            ...
            " sources to build a convincing case for a low-risk approach adjustment"
            ...
            f" {current_neutral_response}."
            " If there are no responses from the other viewpoints,"
            " do not hallucinate and just present your point.\n\n"
            "Engage by questioning their optimism and emphasizing the potential downsides"
            " they may have overlooked. Address each of their counterpoints to showcase why"
            " a conservative stance is ultimately the safest path for the firm's assets."
            " Focus on debating and critiquing their arguments to demonstrate the strength"
            " of a low-risk strategy over their approaches."
